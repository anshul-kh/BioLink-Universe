...
const Home_prof = () => {
  return (
       <div className='z-30  top-32 md:absolute md:right-40 flex  flex-col md:flex-row justify-center items-center md:gap-5 drop-shadow-[0_35px_35px_rgba(0,0,0,0.1)]'>
